    ...
    const projects: Project[] = [
        {
            ...
            description: "Fintrack is a financial tracker where you can effortlessly track all your income and expenses. It allows you to categorize each transaction, allocate them to designated accounts, and categorize your income and expenses depending on where they come from",
            technologies: [{ svg: ts, alt: "ts logo" }, { svg: react, alt: "react logo" }, { svg: next, alt: "next logo" }, { svg: mysql, alt: "mysql logo" }, { svg: tailwind, alt: "tailwind logo" }, { svg: prisma, alt: "prisma logo" }],
            images: [{svg:fin1, alt:"img1" },{svg:fin2, alt:"img1" },{svg:fin3, alt:"img1" },{svg:fin4, alt:"img1" }]
        },
        { 
            name: "Substancial",  
            description: "Landing page for Substancial restaurant, in which I worked as co-designer and programmer.<br></br>(In development) ",
            technologies: [ {svg:vite, alt:"vite logo"}, { svg: ts, alt: "ts logo" }, { svg: react, alt: "sql" }, { svg: css, alt: "java" }, {svg: tailwind, alt:"tailwind logo"}],
            images: [{svg:subs2, alt:"img1" },{svg:subs1, alt:"img1" },{svg:subs3, alt:"img1" }, {svg:subs4, alt:"img1" }]
        },
        { 
            name: "Math.simple",  
            web: "https://mathsimple.netlify.app",
            github: "https://github.com/Nonqs/Math.simple",
            description: "Math.simple is a math problem generator. It was planned to help people who want to practice exercise and don't want to search through a lot of worksheets that have no answers or ways to validate their results.<br /><br />The project is in demo; it only generates subtraction, additions, multiplications and division, but my plan is to add new features, from powers and roots to matrixes.",
            technologies: [{svg:vite, alt:"vite logo"}, { svg: ts, alt: "ts logo" }, { svg: react, alt: "sql" }, { svg: css, alt: "java" }],
            images: [{svg:math1, alt:"img1" },{svg:math2, alt:"img1" },{svg:math3, alt:"img1" }]
        }
    ];
