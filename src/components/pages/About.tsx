    ...
    return (
        <div ref={aboutRef} className='w-full md:w-1/3 me-5'>
            <div className='h-3/4 flex flex-col items-center justify-center'>
                <h4 className={`text-[#01c38d] text-xl md:text-4xl mb-2 font-semibold p-2 border-animated w-2/3 md:w-full text-center md:text-left ${isVisible ? 'animate-border' : ''}`}>
                    Find out who you are hiring
                </h4>
                <article className='w-4/5 md:w-full'>
                    <p className={`${isVisible ? 'text-xs md:text-base opacity-100 transition-opacity duration-1000' : 'opacity-0'} mb-2`}>
                    ...
                    <p className={`${isVisible ? 'text-xs md:text-base opacity-100 transition-opacity duration-1000' : 'opacity-0'}`}>
            ...
            <div className='h-1/4 flex flex-col items-center justify-center'>
                ...
                <div className={`w-full flex justify-center ${isVisible ? 'animate-fade-in' : ''}`}>
                    <article className={`bg-white drop-shadow-lg w-1/6 md:w-1/4 me-5 p-3 rounded-xl text-center hover:drop-shadow-2xl transform hover:scale-110 transition-transform duration-200 ease-in-out `}>
                    ...
                    <article className={`bg-white drop-shadow-lg w-1/6 md:w-1/4 p-3 rounded-xl text-center hover:drop-shadow-2xl transform hover:scale-110 transition-transform duration-200 ease-in-out`}>
