        ...
        <div ref={aboutRef} className='w-1/3 me-5'>
            ...
            <div className='h-1/2'>
                ...
                <div className='w-full flex'>
                    <article className={`bg-white drop-shadow-xl w-1/4 me-5 p-3 rounded-xl text-center hover:drop-shadow-2xl ${isVisible ? 'animate-fade-in' : ''}`}>
                    ...
                    <article className={`bg-white drop-shadow-xl w-1/4 p-3 rounded-xl text-center hover:drop-shadow-2xl ${isVisible ? 'animate-fade-in' : ''}`}>
