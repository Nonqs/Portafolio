...
export default function PresentationText() {
  ...
  return (
    <div className="flex flex-col items-center mt-52">
      <span className="text-[#01c38d] font-semibold text-2xl">
        Hello there, I am
      </span>
      ...
      <article className="relative h-10 w-full flex justify-center items-center">
        {spanSelector === 1 && (
          <span className="text-[#01c38d] text-2xl block font-mono whitespace-nowrap border-r-4 animate-span">
            Your Next Backend Dev
          </span>
        )}
        {spanSelector === 2 && (
          <span className="text-[#01c38d] text-2xl block font-mono whitespace-nowrap border-r-4 w-[18ch] animate-span2">
            Your Next Fullstack Dev
          </span>
        )}
        {spanSelector === 3 && (
          <span className="text-[#01c38d] text-2xl block font-mono whitespace-nowrap border-r-4 w-[28ch] animate-span3">
